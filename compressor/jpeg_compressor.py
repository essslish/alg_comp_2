"""
Модуль реализации JPEG-подобного компрессора и декомпрессора.

Pipeline сжатия:
 1. RGB → YCbCr (ITU-R BT.601)
 2. Даунсэмплинг Cb, Cr (2×2 → 1×1)
 3. Разбиение на блоки N×N
 4. DCT-II 2D
 5. Квантование (таблицы + уровень качества)
 6. ZigZag-сканирование
 7. Дифференциальное кодирование DC
 8. RLE-кодирование AC
 9. Энтропийное кодирование (Хаффман)
10. Формирование файла: заголовок + payload

Pipeline декомпрессии — в обратном порядке.
"""
